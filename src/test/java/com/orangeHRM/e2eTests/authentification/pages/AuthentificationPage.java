...
public class AuthentificationPage {
	...
	final static String BOUTTON_LOGIN_ID = "btnLogin";
	final static String MESSAGE_WELCOM_ID = "welcome";
	...
	@FindBy(how = How.ID, using = BOUTTON_LOGIN_ID)
	public static WebElement btnLogin;
	@FindBy(how = How.ID, using = MESSAGE_WELCOM_ID)
